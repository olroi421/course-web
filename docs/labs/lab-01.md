# Лабораторна робота 1.  Розробка backend архітектури та основного функціоналу
...
12. Cтворити звіт в папці `/reports/` за запропонованим шаблоном (). Звіт `lab1-report.md` і скріншоти помістити в папку.
