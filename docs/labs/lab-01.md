...
12. Cтворити звіт в папці `/reports/` за запропонованим шаблоном ([:fontawesome-solid-download: завантажити шаблон](assets/lab1-report.md)). Звіт `lab1-report.md` і скріншоти помістити в папку.
