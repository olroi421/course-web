# Лабораторна робота 01 Розроблення backend архітектури та основного функціоналу
...
12. Cтворити звіт в папці `reports/` за запропонованим шаблоном ([завантажити шаблон](assets/lab1-report.md.download)). Звіт `lab1-report.md` і скріншоти помістити в папку.
